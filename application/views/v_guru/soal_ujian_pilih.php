      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-4">
            ...
            <a href="<?= base_url('C_Guru/edit_ujian/').$ujian['id_ujian']; ?>" class="btn btn-block btn-info">
        ...
        <div class="row">
          <div class="col-4">
            <a href="<?= base_url('C_Guru/edit_ujian/').$ujian['id_ujian']; ?>" class="btn btn-info">
              <i class="fa fa-arrow-circle-left"></i>
              &nbsp;&nbsp; Halaman Sebelumnya
            </a>
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?= base_url('C_Guru/tambahSoalUjian/'.$ujian['id_ujian'].'/'.$ujian['id_guru'].'/'
              ...
              <div class="row">
                ...
                <div class="form-group col-6">
                  <label for="exampleSelectRounded0">Kategori Soal</label>
                    <select class="custom-select rounded-0" name="id_kategori">
